...
export default function StudyMaterialsModeration() {
    ...
    const [editForm, setEditForm] = useState({
        ...
        croppedImages: {} as Record<string, string>, // Store cropped versions
    });
    ...
    const handleOpenCropModal = (imageUrl: string) => {
        // Proxy the image URL for cropping to avoid CORS issues
    ...
    //         croppedImages: {
    //             ...prev.croppedImages,
    //             [currentImageToCrop]: croppedImageData
    //         }
    //     }));
    //
    //     toast.success('Image cropped successfully');
        ...
        try {
            ...
            if (data.success) {
                ...
                setEditForm({
                    ...
                    exam_board: data.material.exam_board,
