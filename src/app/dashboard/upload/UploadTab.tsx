...
export default function UploadTab() {
    ...
    const isPro                        = true; // wire to your subscription check
                ...
                <div style={{
                    ...
                    <div
                        ...
                        style={{
                            ...
                            background: isDragging ? '#EFF6FF' : file ? '#fff' : '#fff',
                            transition: 'all 0.2s',
                            marginBottom: 14,
                        }}
                    >
...
// ─── Generated Viewer (inline, no routing) ────────────────────────────────────

function GeneratedViewer({
                             content, difficulty, savedId, saving, onSave,
                         }: {
                        ...
                        {content.questions.map((q, i) => {
                            ...
                            return (
                                <div key={i} style={{ ...s.card, marginBottom: 12 }}>
                                    ...
                                    <p style={{ fontSize: 13.5, fontWeight: 500, color: '#111827', marginBottom: 11, lineHeight: 1.55, margin: '0 0 12px' }}>
                                        {q.text}
                                    </p>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 9 }}>
                            {content.flashcards.map((f, i) => (
                                ...
                                >
                                    {flipped[i] ? (
                                        <>
                                            <div style={{ fontSize: 9.5, fontWeight: 500, color: '#3B82F6', marginBottom: 5, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                                                Definition
                                            </div>
                                        ...
                                        <>
                                            <div style={{ fontSize: 9.5, fontWeight: 500, color: '#9CA3AF', marginBottom: 5, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                                                Term
                                            </div>
