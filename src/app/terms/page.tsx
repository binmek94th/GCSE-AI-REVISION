                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 md:p-12">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-slate-700 leading-relaxed mb-4">
                            These Terms of Service (&#34;Terms&#34;) govern your use of the GCSE website, applications, and services (the &#34;Service&#34;), operated by {serviceDetails.legalEntityName} (&#34;GCSE&#34;, &#34;we&#34;, &#34;us&#34;, &#34;our&#34;).
                        </p>
                    ...
                    <section id="definitions" className="mb-10 scroll-mt-6">
                        ...
                        <div className="space-y-3">
                            <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
                                <p className="text-slate-700"><strong>Account:</strong> Your registered user profile on GCSE</p>
                            </div>
                            <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
                    ...
                    <section id="privacy" className="mb-10 scroll-mt-6">
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-5">
                            ...
                            <p className="text-sm text-slate-700">
                                By using GCSE, you consent to the data practices described in our Privacy Policy, including the processing of your study data, AI Tutor interactions, and account information.
                            </p>
                        </div>
                    </section>
                    ...
                    <section id="indemnification" className="mb-10 scroll-mt-6">
                        ...
                        <p className="text-slate-700 mb-3">
                            You agree to indemnify, defend, and hold harmless GCSE, its officers, directors, employees, and agents from any claims, liabilities, damages, losses, and expenses (including legal fees) arising from:
                        </p>
                    ...
                    <div className="bg-slate-900 text-white rounded-lg p-6 text-center">
                        ...
                        <p className="text-sm">
                            By using GCSE, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
                        </p>
                    </div>
